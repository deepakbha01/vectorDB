...
export type PhaseKey = 'discovery' | 'data_embeddings' | 'index_design' | 'vector_db_selection' | 'infrastructure' | 'optimization' | 'capacity' | 'inference' | 'workload_profile' | 'model_selection' | 'inference_architecture' | 'infrastructure_design';
