...
export type PhaseKey = 'discovery' | 'data_embeddings' | 'index_design' | 'vector_db_selection' | 'infrastructure' | 'optimization' | 'capacity' | 'inference' | 'workload_profile' | 'model_selection' | 'inference_architecture' | 'infrastructure_design' | 'rag_agent_architecture' | 'security_governance' | 'performance_benchmark' | 'finops' | 'operations_model' | 'final_recommendation' | 'token_observability';
...
export type AssessmentState = Record<
  'useCase' | 'scale' | 'data' | 'embedding' | 'vectorDB' | 'index' | 'model' | 'inference' | 'tokenObservability' | 'infrastructure' | 'rag' | 'security' | 'performance' | 'cost' | 'operations' | 'recommendation',
  StateSection
>;
